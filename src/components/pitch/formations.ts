...
export const FORMATIONS: Record<string, { label: string; pos: [number, number] }[]> = {
  "4-3-3": [
    ...
    { label: "MC",  pos: [14, 57] }, { label: "MCC", pos: [34, 60] }, { label: "MC",  pos: [54, 57] },
  ...
  "3-5-2": [
    ...
    { label: "MI",  pos: [8,  55] }, { label: "MC",  pos: [22, 51] }, { label: "MCC", pos: [34, 45] }, { label: "MC",  pos: [46, 51] }, { label: "MD",  pos: [60, 55] },
    { label: "DC",  pos: [24, 22] }, { label: "DC",  pos: [44, 22] },
  ],
  "4-2-3-1": [
    { label: "ARQ", pos: [34, 93] },
  ...
  "5-3-2": [
    ...
    { label: "MC",  pos: [18, 54] }, { label: "MCC", pos: [34, 45] }, { label: "MC",  pos: [50, 54] },
    { label: "DC",  pos: [24, 22] }, { label: "DC",  pos: [44, 22] },
  ],
};
